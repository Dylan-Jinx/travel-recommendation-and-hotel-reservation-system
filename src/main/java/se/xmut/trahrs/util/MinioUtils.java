...
public class MinioUtils {
    public static String HOST = YamlUtil.getStringByYaml("Minio.host");
    public static String PORT = YamlUtil.getStringByYaml("Minio.port");
    public static String ACCESSKEY = YamlUtil.getStringByYaml("Minio.access_key");
    public static String SECRETKEY = YamlUtil.getStringByYaml("Minio.secret_key");
